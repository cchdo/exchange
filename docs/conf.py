# -*- coding: utf-8 -*-
#
# Exchange Format documentation build configuration file, created by
...
#html_theme_path = ['../../../src/sphinx_rtd_theme/']
...
htmlhelp_basename = 'ExchangeFormatdoc'
...
latex_documents = [
  ('index', 'ExchangeFormat.tex', u'Exchange Format Description',
   u'Andrew M. Barna, James H. Swift, Stephen C. Diggs', 'manual'),
]
...
man_pages = [
    ('index', 'exchangeformat', u'Exchange Format Documentation',
     [u'James H. Swift, Stephen C. Diggs'], 1)
]
...
texinfo_documents = [
  ('index', 'ExchangeFormat', u'Exchange Format Documentation',
   u'James H. Swift, Stephen C. Diggs', 'ExchangeFormat', 'One line description of project.',
   'Miscellaneous'),
]
